# Formspec App Manifest Specification v2.3 (LLM Reference)
...
|---|---|---|---|---|
| `#/properties/$formspecBundle` | yes | string | Version pin for App Manifest document compatibility | App Manifest specification version. MUST be '2.0', '2.1', '2.2', or '2.3'. The v2.0 bump from '1.0' is structural; v2.1 introduces dataSources[] sibling references; v2.2 introduces components[] sibling references; v2.3 introduces screeners[] sibling references. Documents with dataSources[] MUST use '2.1' or later. Documents with components[] MUST use '2.2' or later. Documents with screeners[] MUST use '2.3'. |
