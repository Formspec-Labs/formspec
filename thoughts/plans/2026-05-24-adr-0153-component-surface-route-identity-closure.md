...
**Status:** Partial. Route identity schema, shared validator checks, and
graph-wide provenance schema evidence are landed; Studio/kernel identity,
production consumers, explicit graph binding, and Definition id alias matching
remain open.
