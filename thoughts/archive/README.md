...
| [`research/`](research/) | Closed research and field records — model studies, user research, and defect logs from building demos against the stack (e.g. the NJ weekly certification demo) |
