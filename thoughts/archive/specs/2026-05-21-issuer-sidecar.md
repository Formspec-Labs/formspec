...
**Date:** 2026-05-21
**Status:** Implemented — schema, spec, 22 conformance fixtures, Rust lint, TS engine, webcomponent chrome, E2E tests all landed. Implementation plan archived at `thoughts/archive/plans/2026-05-21-issuer-sidecar.md`.
