...
- **P1 — Posture admission** (`for-n8c4`, `for-r8c4`, `for-s8c4` done): E608/E609 lint + shared matcher; formspec-server publish/submit bundle gate; studio branch-open gate (`Project.openAuthoringChangeset`, interim `ProposalManager` until ADR 0151 P3). Host wiring: [`../thoughts/deployment-posture-wiring.md`](../thoughts/deployment-posture-wiring.md). Fine-grained scope: ADR 0152 (Held).
