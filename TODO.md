...
- **P1 — Posture static admission** (`for-n8c4` tk ticket): E608/E609 lint pass + shared matcher in formspec/app-graph. Runtime gates: **`for-r8c4`** (formspec-server bundle revalidation) and **`for-s8c4`** (studio branch-open actor admission).
