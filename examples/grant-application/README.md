...
| `registry.json` | Registry | Local example registry (`x-formspec-ein` dataType); `definition.json` still references the published `formspec-common` registry URL for remote resolution demos |
