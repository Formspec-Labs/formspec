"""Integrity checks for Surface experience-unit app-graph fixtures."""
...
FIXTURE_PATH = (
    ...
    / "fixtures"
    / "app-graph-validator"
    / "surface-experience-units.case.json"
)

REQUIRED_CASES = {
    "valid-route-local-experience-unit",
    "experience-unit-route-definition-mismatch",
    "experience-unit-ref-unresolved",
}

EXPECTED_CODES = {
    "experience-unit-route-definition-mismatch": "APP-GRAPH-SURFACE-EXPERIENCE-UNIT-DEFINITION",
    "experience-unit-ref-unresolved": "APP-GRAPH-SURFACE-EXPERIENCE-UNIT-REF",
}
...
def test_surface_experience_unit_fixture_covers_required_cases() -> None:
    ids = {case["id"] for case in _corpus()["cases"]}
    assert ids == REQUIRED_CASES


def test_surface_experience_unit_fixture_sources_are_explicit() -> None:
    corpus = _corpus()
...
def test_surface_experience_unit_fixture_expected_diagnostics_are_app_graph_owned() -> None:
    for case in _corpus()["cases"]:
        ...
        for diagnostic in diagnostics:
            assert diagnostic["code"].startswith("APP-GRAPH-SURFACE-EXPERIENCE-UNIT-")
...
def test_surface_experience_unit_fixture_keeps_runtime_trace_and_auth_out() -> None:
