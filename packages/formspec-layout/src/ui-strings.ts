 ...
 * count, max, status, reason) filled by {@link fillUiParams} — never FEL, never the form scope.
 */
 ...
 */
export function fillUiParams(template: string, params?: Record<string, string | number>): string {
