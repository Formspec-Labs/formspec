...
const FIXTURE_PATH = resolve(
  fileURLToPath(new URL('../../../tests/conformance/fixtures/app-graph-validator/surface-response-action-triggers.case.json', import.meta.url)),
);
...
describe('Surface Response Actions trigger source conformance fixtures', () => {
