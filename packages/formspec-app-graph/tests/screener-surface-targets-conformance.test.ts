...
const FIXTURE_PATH = resolve(
  fileURLToPath(new URL('../../../tests/conformance/fixtures/app-graph-validator/screener-surface-targets.case.json', import.meta.url)),
);
...
describe('Screener surface target source conformance fixtures', () => {
