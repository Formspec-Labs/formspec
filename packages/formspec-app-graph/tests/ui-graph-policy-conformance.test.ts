...
const FIXTURE_PATH = resolve(
  fileURLToPath(new URL('../../../tests/conformance/fixtures/app-graph-validator/ui-graph-policy-surface-routes.case.json', import.meta.url)),
);
...
describe('UI Graph Policy Surface/route source conformance fixtures', () => {
