...
const FIXTURE_PATH = resolve(
  fileURLToPath(new URL('../../../tests/conformance/fixtures/app-graph-validator/surface-experience-units.case.json', import.meta.url)),
);
...
describe('Surface experience-unit source conformance fixtures', () => {
