...
export type { ModuleResolutionModuleStatus, ModuleResolutionSeverity, ModuleResolutionPhase, ModuleResolutionOrigin, ModuleResolutionDocumentStatus, ModuleResolutionContributionStatus, ModuleResolutionPayloadStatus, ModuleResolutionPhaseStatusValue, ModuleResolutionReport, ModuleResolutionModule, ModuleResolutionRef, ModuleResolutionExtensions, ModuleResolutionSourcePointer, ModuleResolutionArtifactRef, ModuleResolutionDiagnostic, ModuleResolutionDocument, ModuleResolutionContribution, ModuleResolutionSummary, ModuleResolutionPhaseStatus, ModuleResolutionSupportProfile } from './module-resolution-report.js';
