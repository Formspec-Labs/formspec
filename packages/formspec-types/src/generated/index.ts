...
export type { ValueClass, BuiltInWidgetName, CustomWidgetName, WidgetName, ThemeWidgetName, CommonSchema, TargetDefinition, Tokens, Breakpoints, ContactPoint, LangMap, Party, StyleMap, Extensions, AccessibilityBlock, VisualSurfaceProps, ModuleRef, AuthorActor, SessionRef, Generation, ComponentNodeIdentityRef, CrossComponentRef } from './common.js';
