...
/**
 * A single row of the master mapping table or a Response Actions override. Permitted (profile, blocking, persistence) tuples are governed by the §6.3 predicate; processors MUST reject overrides that violate it.
 *
 * This interface was referenced by `ValidationMappingDocument`'s JSON-Schema
