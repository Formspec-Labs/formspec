        ...
        slots: [
          ...
          },
          {
            ...
            binding: {
              ...
              config: {
                dataSource: 'x-spike-v8:workspace:webhook-secret',
                // x-spike-v8 — no substrate sensitivity annotation exists. FINDING 27.
                sensitivity: 'x-spike-v8:secret',
          ...
          },
          {
            ...
            binding: {
              ...
              config: {
                dataSource: 'x-spike-v8:workspace:webhook-endpoints',
          ...
          },
          {
            ...
            binding: {
              ...
              config: {
                dataSource: 'x-spike-v8:workspace:webhook-deliveries',
