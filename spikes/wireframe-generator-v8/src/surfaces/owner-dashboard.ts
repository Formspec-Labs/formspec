        ...
        slots: [
          ...
          },
          {
            ...
            binding: {
              ...
              config: { dataSource: 'x-spike-v8:host-status:anchoring', visibleWhen: 'x-spike-v8:TODO:degraded' },
            },
          ...
          },
          {
            ...
            binding: {
              ...
              widgetName: 'KpiTiles',
              config: {
                dataSource: 'x-spike-v8:workspace:metrics',
          ...
          },
          {
            ...
            binding: {
              ...
              config: {
                dataSource: 'x-spike-v8:workspace:proof-distribution',
          ...
          },
          {
            ...
            binding: {
              ...
              config: {
                dataSource: 'x-spike-v8:workspace:forms',
          ...
          },
          {
            ...
            binding: {
              ...
              config: {
                dataSource: 'x-spike-v8:workspace:activity',
          ...
          },
          {
            ...
            binding: {
              ...
              config: { dataSource: 'x-spike-v8:workspace:receipts', limit: 5 },
            },
