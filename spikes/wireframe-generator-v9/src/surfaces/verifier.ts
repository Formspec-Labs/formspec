...
export const verifier: SurfaceScript = {
   ...
   */
  tenantThemeProbe: [
    { widgetRef: { moduleId: 'x-cloud-verification-result', widgetName: 'VerificationResult' }, slot: 'accent', token: 'color.accent' },
    { widgetRef: { moduleId: 'x-cloud-computation-log', widgetName: 'ComputationLog' }, slot: 'surface', token: 'color.surface' },
  ],
  brief:
    ...
    const routes = [
      {
        routeId: 'verify',
        path: '/verify',
        routeClass: 'verification' as const,
        ...
        slots: [
          ...
          },
          {
            ...
            binding: {
              ...
              config: {
                ...
                persist: false,
                publishes: 'x-spike-v9:channel:receipt-bytes',
              },
            },
            title: 'Receipt input',
            position: 'main',
          ...
          },
          {
            ...
            binding: {
              ...
              config: {
                consumes: 'x-spike-v9:channel:receipt-bytes',
                executor: 'x-spike-v9:client-only',
                emits: 'x-spike-v9:channel:verification-result',
              },
            },
          ...
          },
          {
            ...
            binding: {
              ...
              config: {
                consumes: 'x-spike-v9:channel:verification-result',
                checks: [
          ...
          },
          {
            ...
            binding: {
              ...
              config: { consumes: 'x-spike-v9:channel:verification-result', streaming: true },
            },
