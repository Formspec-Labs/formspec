...
export const adminBilling: SurfaceScript = {
  ...
  async author({ mcp, gap, bindRoute }) {
    ...
    const planPanel = await mcp.addExperienceUnit({
      ...
      kind: 'x-spike-v9:read-only-panel',
      title: 'Current plan',
    });
        ...
        slots: [
          ...
          },
          {
            ...
            binding: {
              ...
              config: {
                dataSource: 'x-spike-v9:workspace:usage',
          ...
          },
          {
            ...
            binding: {
              ...
              config: { externalHandoff: 'x-spike-v9:external:payment-processor' },
            },
          ...
          },
          {
            ...
            binding: {
              ...
              config: {
                dataSource: 'x-spike-v9:workspace:invoices',
