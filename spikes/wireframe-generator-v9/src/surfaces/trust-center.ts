...
export const trustCenter: SurfaceScript = {
   ...
   */
  tenantThemeProbe: [
    { widgetRef: { moduleId: 'x-cloud-capability-matrix', widgetName: 'CapabilityMatrix' }, slot: 'accent', token: 'color.accent' },
    { widgetRef: { moduleId: 'x-cloud-profile-cards', widgetName: 'DeploymentProfiles' }, slot: 'surface', token: 'color.surface' },
  ],
  brief:
    ...
    const routes = [
      {
        routeId: 'trust',
        path: '/trust',
        routeClass: 'attestation' as const,
        title: 'Trust',
        slots: [
          {
            id: 'publicNav',
          ...
          },
          {
            ...
            binding: {
              ...
              config: {
                dataSource: 'x-spike-v9:catalog:deployment-profiles',
          ...
          },
          {
            ...
            binding: {
              ...
              config: {
                dataSource: 'x-spike-v9:catalog:capability-claims',
                rows: 14,
