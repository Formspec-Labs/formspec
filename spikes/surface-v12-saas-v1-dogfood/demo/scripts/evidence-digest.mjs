...
const REVIEW_INPUT_FILES = [
  ...
  'spikes/surface-v12-saas-v1-dogfood/run-outcome-cases.mjs',
  ...
  'spikes/surface-v12-saas-v1-dogfood/evidence/outcome-verification-review.md',
...
const REVIEW_INPUT_DIRECTORIES = [
  ...
  'packages/formspec-outcome-verification',
